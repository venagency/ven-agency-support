...
4. Create a GitHub release such as `v1.3.10`.
...
```sh
npm run plugin:zip
gh release create v1.3.10 ven-agency-support.zip --repo venagency/ven-agency-support --title "Ven Agency Support 1.3.10" --notes "Release notes"
```
