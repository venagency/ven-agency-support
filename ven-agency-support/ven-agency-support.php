...
.ven-support-assistant__launcher { align-items: center; background: #0f1216; border: 0; border-radius: 999px; box-shadow: 0 12px 32px rgba(15,18,22,.24); cursor: pointer; display: flex; height: 38px; justify-content: center; padding: 0; width: 38px; }
...
(function () {
	...
	if (messages) {
		addMessage('assistant', 'Hi, I can help with website support questions or help you create a task for Ven.');
	}
